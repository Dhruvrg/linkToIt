...
import { ChevronDownIcon, ChevronUpIcon, Tag } from "lucide-react";
...
export default function UTMTermSection({ data = [] }: Props) {
  ...
  const visibleTerms = expanded ? data : data.slice(0, 4);
                  ...
                  <div className="p-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        >
                          <Tag className="h-6 w-6" style={{ color: color }} />
                        </div>
