...
import { ChevronDownIcon, ChevronUpIcon, Megaphone } from "lucide-react";
...
export default function UTMMediumSection({ data = [] }: Props) {
  ...
  const visibleMediums = expanded ? data : data.slice(0, 4);
