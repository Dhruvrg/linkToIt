...
export default function UTMCampaignSection({ data = [] }: Props) {
  ...
  const visibleCampaigns = expanded ? data : data.slice(0, 4);
  ...
  return (
    <Card className="shadow-lg rounded-lg md:w-[18vw] overflow-hidden border border-[#e0d8ff] bg-white">
      <CardHeader className="bg-gradient-to-r from-[#9b7bf7] to-[#7c5ce9] text-white p-6">
        <CardTitle className="text-2xl font-bold flex items-center">
          <Bullhorn className="mr-3 h-6 w-6" />
